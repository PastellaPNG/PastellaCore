...
class CryptoUtils {
    ...
    static generateSeed() {
        const words = [
            ...
            'gleam', 'glide', 'glimpse', 'globe', 'gloom', 'glory', 'glove', 'glow', 'glue', 'goat',
            ...
            'joss', 'journey', 'joy', 'judge', 'juice', 'juicy', 'july', 'jumbo', 'jump', 'june',
            ...
            'poet', 'point', 'polar', 'pole', 'police', 'pond', 'pony', 'pool', 'poor', 'pop',
            ...
            'steak', 'steel', 'steep', 'stem', 'step', 'stereo', 'stick', 'still', 'sting', 'stomach',
            'stone', 'stony', 'stool', 'story', 'stove', 'strategy', 'street', 'strike', 'strong', 'struggle',
            'student', 'stuff', 'stumble', 'stump', 'stun', 'stupid', 'style', 'subject', 'submit', 'subway',
            ...
            'vital', 'vivid', 'vocal', 'voice', 'void', 'volcano', 'volume', 'vote', 'voucher', 'vow',
            'voyal', 'vulnerable', 'wad', 'wagon', 'wait', 'walk', 'wall', 'walnut', 'want', 'warfare',
            'warm', 'warrior', 'wash', 'wasp', 'waste', 'water', 'wave', 'way', 'wealth', 'weapon',
            'wear', 'weasel', 'weather', 'web', 'wedding', 'weekend', 'weird', 'welcome', 'west', 'wet',
            'whale', 'wharf', 'what', 'wheat', 'wheel', 'when', 'where', 'whip', 'whisper', 'wide',
            'width', 'wife', 'wild', 'will', 'willing', 'win', 'window', 'wine', 'wing', 'wink',
